...
export const Icon = ({ name, className, size = 36, ...rest }) => {
	switch (name) {
		case ICON.WALLET: return <Wallet className={className} width={size} height={size} {...rest} />
		case ICON.EXIT: return <Exit className={className} width={size} height={size} {...rest} />
		case ICON.DOCK: return <Dock className={className} width={size} height={size} {...rest} />
		case ICON.DOCK2: return <Dock2 className={className} width={size} height={size} {...rest} />
		case ICON.CARD: return <Card className={className} width={size} height={size} {...rest} />
		case ICON.CARD2: return <Card2 className={className} width={size} height={size} {...rest} />
		case ICON.MONEY: return <Money className={className} width={size} height={size} {...rest} />
